...
class TriagingEngineTest {
    ...
    void sortsStatBeforeUrgentBeforeRoutineThenFifo() {
        ...
        Order r = new LabOrder("r", "p", "c", "d", Priority.ROUTINE, t1, OrderStatus.PENDING);
        Order u = new LabOrder("u", "p", "c", "d", Priority.URGENT, t0, OrderStatus.PENDING);
        Order s = new LabOrder("s", "p", "c", "d", Priority.STAT, t1, OrderStatus.PENDING);
        Order r2 = new LabOrder("r2", "p", "c", "d", Priority.ROUTINE, t0, OrderStatus.PENDING);
